...
function shiftToRight(inputIntegerValue , inputRightShiftValue) {
    let rightShiftOperatorValue = Math.floor(inputIntegerValue / 2 ** inputRightShiftValue);
    return rightShiftOperatorValue;
}
